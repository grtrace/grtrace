...
nothrow @nogc extern (System)
{
	...
	alias fp_glTexImage1D = void function(GLenum, GLint, GLint, GLsizei, GLint,
		GLenum, GLenum, const(void)*);
	alias fp_glTexImage2D = void function(GLenum, GLint, GLint, GLsizei,
	...
	alias fp_glReadPixels = void function(GLint, GLint, GLsizei, GLsizei, GLenum, GLenum,
		void*);
	...
	alias fp_glBitmap = void function(GLsizei, GLsizei, GLfloat, GLfloat,
	...
	alias fp_glMap2d = void function(GLenum, GLdouble, GLdouble, GLint, GLint,
		GLdouble, GLdouble, GLint, GLint, const(GLdouble)*);
	alias fp_glMap2f = void function(GLenum, GLfloat, GLfloat, GLint, GLint,
	...
	alias fp_glMapGrid2d = void function(GLint, GLdouble, GLdouble, GLint, GLdouble,
		GLdouble);
	...
	alias fp_glFrustum = void function(GLdouble, GLdouble, GLdouble, GLdouble, GLdouble,
		GLdouble);
	...
	alias fp_glOrtho = void function(GLdouble, GLdouble, GLdouble, GLdouble, GLdouble,
		GLdouble);
	...
	alias fp_glCopyTexImage1D = void function(GLenum, GLint, GLenum, GLint, GLint,
		GLsizei, GLint);
	alias fp_glCopyTexImage2D = void function(GLenum, GLint, GLenum, GLint,
		GLint, GLsizei, GLsizei, GLint);
	alias fp_glCopyTexSubImage1D = void function(GLenum, GLint, GLint, GLint, GLint,
		GLsizei);
	alias fp_glCopyTexSubImage2D = void function(GLenum, GLint, GLint, GLint,
		GLint, GLint, GLsizei, GLsizei);
	alias fp_glTexSubImage1D = void function(GLenum, GLint, GLint, GLsizei,
		GLenum, GLenum, const(void)*);
	alias fp_glTexSubImage2D = void function(GLenum, GLint, GLint, GLint,
	...
	alias fp_glDrawRangeElements = void function(GLenum, GLuint, GLuint,
		GLsizei, GLenum, const(void)*);
	alias fp_glTexImage3D = void function(GLenum, GLint, GLint, GLsizei,
		GLsizei, GLsizei, GLint, GLenum, GLenum, const(void)*);
	alias fp_glTexSubImage3D = void function(GLenum, GLint, GLint, GLint,
		GLint, GLsizei, GLsizei, GLsizei, GLenum, GLenum, const(void)*);
	alias fp_glCopyTexSubImage3D = void function(GLenum, GLint, GLint, GLint,
	...
	alias fp_glCompressedTexImage3D = void function(GLenum, GLint, GLenum,
		GLsizei, GLsizei, GLsizei, GLint, GLsizei, const(void)*);
	alias fp_glCompressedTexImage2D = void function(GLenum, GLint, GLenum,
		GLsizei, GLsizei, GLint, GLsizei, const(void)*);
	alias fp_glCompressedTexImage1D = void function(GLenum, GLint, GLenum,
		GLsizei, GLint, GLsizei, const(void)*);
	alias fp_glCompressedTexSubImage3D = void function(GLenum, GLint, GLint,
		GLint, GLint, GLsizei, GLsizei, GLsizei, GLenum, GLsizei, const(void)*);
	alias fp_glCompressedTexSubImage2D = void function(GLenum, GLint, GLint,
		GLint, GLsizei, GLsizei, GLenum, GLsizei, const(void)*);
	alias fp_glCompressedTexSubImage1D = void function(GLenum, GLint, GLint,
	...
	alias fp_glMultiTexCoord4d = void function(GLenum, GLdouble, GLdouble, GLdouble,
		GLdouble);
	...
	alias fp_glMultiDrawArrays = void function(GLenum, const(GLint)*, const(GLsizei)*,
		GLsizei);
	alias fp_glMultiDrawElements = void function(GLenum, const(GLsizei)*,
	...
	alias fp_glGetActiveAttrib = void function(GLuint, GLuint, GLsizei,
		GLsizei*, GLint*, GLenum*, GLchar*);
	alias fp_glGetActiveUniform = void function(GLuint, GLuint, GLsizei,
		GLsizei*, GLint*, GLenum*, GLchar*);
	...
	alias fp_glVertexAttrib4Nub = void function(GLuint, GLubyte, GLubyte, GLubyte,
		GLubyte);
	...
	alias fp_glVertexAttrib4d = void function(GLuint, GLdouble, GLdouble, GLdouble,
		GLdouble);
	...
	alias fp_glVertexAttribPointer = void function(GLuint, GLint, GLenum,
	...
	alias fp_glColorMaski = void function(GLuint, GLboolean, GLboolean, GLboolean,
		GLboolean);
	...
	alias fp_glTransformFeedbackVaryings = void function(GLuint, GLsizei,
		const(GLchar*)*, GLenum);
	alias fp_glGetTransformFeedbackVarying = void function(GLuint, GLuint,
	...
	alias fp_glVertexAttribIPointer = void function(GLuint, GLint, GLenum, GLsizei,
		const(void)*);
	...
	alias fp_glFramebufferTexture1D = void function(GLenum, GLenum, GLenum, GLuint,
		GLint);
	alias fp_glFramebufferTexture2D = void function(GLenum, GLenum, GLenum, GLuint,
		GLint);
	alias fp_glFramebufferTexture3D = void function(GLenum, GLenum, GLenum, GLuint,
		GLint, GLint);
	alias fp_glFramebufferRenderbuffer = void function(GLenum, GLenum, GLenum, GLuint);
	alias fp_glGetFramebufferAttachmentParameteriv = void function(GLenum, GLenum,
		GLenum, GLint*);
	alias fp_glGenerateMipmap = void function(GLenum);
	alias fp_glBlitFramebuffer = void function(GLint, GLint, GLint, GLint,
		GLint, GLint, GLint, GLint, GLbitfield, GLenum);
	alias fp_glRenderbufferStorageMultisample = void function(GLenum, GLsizei,
		GLenum, GLsizei, GLsizei);
	alias fp_glFramebufferTextureLayer = void function(GLenum, GLenum, GLuint, GLint,
		GLint);
	...
	alias fp_glDrawElementsInstanced = void function(GLenum, GLsizei, GLenum,
		const(void)*, GLsizei);
	alias fp_glTexBuffer = void function(GLenum, GLenum, GLuint);
	alias fp_glPrimitiveRestartIndex = void function(GLuint);
	alias fp_glCopyBufferSubData = void function(GLenum, GLenum, GLintptr, GLintptr,
		GLsizeiptr);
	alias fp_glGetUniformIndices = void function(GLuint, GLsizei, const(GLchar*)*,
		GLuint*);
	alias fp_glGetActiveUniformsiv = void function(GLuint, GLsizei,
		const(GLuint)*, GLenum, GLint*);
	alias fp_glGetActiveUniformName = void function(GLuint, GLuint, GLsizei, GLsizei*,
		GLchar*);
	...
	alias fp_glGetActiveUniformBlockName = void function(GLuint, GLuint,
		GLsizei, GLsizei*, GLchar*);
	alias fp_glUniformBlockBinding = void function(GLuint, GLuint, GLuint);
	alias fp_glDrawElementsBaseVertex = void function(GLenum, GLsizei,
		GLenum, const(void)*, GLint);
	alias fp_glDrawRangeElementsBaseVertex = void function(GLenum, GLuint,
		GLuint, GLsizei, GLenum, const(void)*, GLint);
	alias fp_glDrawElementsInstancedBaseVertex = void function(GLenum, GLsizei,
		GLenum, const(void)*, GLsizei, GLint);
	alias fp_glMultiDrawElementsBaseVertex = void function(GLenum,
		const(GLsizei)*, GLenum, const(void*)*, GLsizei, const(GLint)*);
	...
	alias fp_glTexImage2DMultisample = void function(GLenum, GLsizei, GLenum,
		GLsizei, GLsizei, GLboolean);
	alias fp_glTexImage3DMultisample = void function(GLenum, GLsizei, GLenum,
	...
	alias fp_glBindFragDataLocationIndexed = void function(GLuint, GLuint,
		GLuint, const(GLchar)*);
